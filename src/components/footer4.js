        ...
        <div className="footer4-content">
          ...
          <div className="footer4-links">
            ...
            >
              {props.link2 ?? (
                <Fragment>
                  <span className="footer4-text18 thq-body-small">Tickets</span>
                </Fragment>
              )}
            </a>
            <a
            ...
            >
              {props.link4 ?? (
                <Fragment>
                  <span className="footer4-text19 thq-body-small">Contact</span>
                </Fragment>
              )}
            </a>
            <a
            ...
            >
              {props.link5 ?? (
                <Fragment>
                  <span className="footer4-text14 thq-body-small">FAQ</span>
                </Fragment>
              )}
            </a>
          </div>

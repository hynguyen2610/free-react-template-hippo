                ...
                {props.step1Description ?? (
                  <Fragment>
                    <span className="steps2-text25 thq-body-small">
                      Browse through our selection of tickets and choose the one
                ...
                {props.step3Description ?? (
                  <Fragment>
                    <span className="steps2-text26 thq-body-small">
                      Double-check your order details, make any necessary
                      changes, and proceed to payment.
                    </span>
                  </Fragment>
                )}
              </span>
                ...
                {props.step4Description ?? (
                  <Fragment>
                    <span className="steps2-text31 thq-body-small">
                      Once the payment is confirmed, you will receive your
                      ticket via email or download it directly from your
                      account.
                    </span>
                  </Fragment>
                )}
